...
import cz.luck.ditto.model.sumsub.AccessToken;
import cz.luck.ditto.model.sumsub.Applicant;
import cz.luck.ditto.model.sumsub.DocType;
import cz.luck.ditto.model.sumsub.HttpMethod;
import cz.luck.ditto.model.sumsub.Metadata;
...
@Service
public class SumSubServiceImpl {

    // The description of the authorization method is available here: https://docs.sumsub.com/reference/authentication
    private static final String SUMSUB_APP_TOKEN = "sbx:FVfMghuUatua0Wbv4pUdAM8p.oh1jGfMr1yJN1jQ3Z0L8ySsG6GihpaPX";
    private static final String SUMSUB_SECRET_KEY = "ew1wOQ4J9l8wN59j5gMXJ5bhtyHiAx1f";
    ...
    private static final Logger log = LoggerFactory.getLogger(SumSubServiceImpl.class);
    ...
    public void test() throws IOException, InvalidKeyException, NoSuchAlgorithmException {
        ...
        String imageId = addDocument(applicantId, new File(SumSubServiceImpl.class.getResource("/images/sumsub-logo.png").getFile()));
    ...
    public void getApiStatus() throws NoSuchAlgorithmException, InvalidKeyException, IOException {

        Response response = sendGet("/resources/status/api");

        log.info("Reponse from API status: {}",
                objectMapper.writeValueAsString(response.body() != null ? response.body().string() : null)
        );
